...
public struct iPhoneNumberField: UIViewRepresentable {
    ...
    private var isPhoneNumberValid: Binding<Bool>
    ...
    internal var validBackgroundColor: UIColor = .white // Background color when the number is valid
    internal var invalidBackgroundColor: UIColor = .red.withAlphaComponent(0.5) // Background color when the number is invalid
    ...
    public init(_ title: String? = nil,
                ...
                isPhoneNumberValid: Binding<Bool>,
                formatted: Bool = true,
    ...
    public func updateUIView(_ uiView: PhoneNumberTextField, context: UIViewRepresentableContext<Self>) {
        ...
        isPhoneNumberValid.wrappedValue = uiView.isValidNumber
